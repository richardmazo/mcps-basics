...
servidor.registerResource("saludar", new ResourceTemplate("saludar://{nombre}", { list: undefined }), { title: "Recurso para saludar", description: "Pidele un saludo a Richard" }, async (url, { nombre }) => {
